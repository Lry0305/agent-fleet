...
DEFAULT_AGENTS = [
    ...
    Agent(
        ...
        name="Diana",
        role=ROLE_PROVIDER,
        private_key="0x7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6",  # hardhat 默认账户 #3（之前手打的 key 多打了一位/错位，链上没有余额，转账会 revert）
    ...
    Agent(
        ...
        name="Eve",
        role=ROLE_PROVIDER,
        private_key="0x47e179ec197488593b187f80a00eb0da91f1b9d0b13f8733639f19c30a34926a",  # hardhat 默认账户 #4（同上，之前的 key 是拼错的，不是真实账户）
