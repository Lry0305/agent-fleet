...
def main():
    print("=" * 60)
    print("  AgentFleet Skill — Provider 完整演示")
    print("=" * 60)

    client = AgentFleetClient(api_base="http://127.0.0.1:8765")
    ...
    print("\n[4/5] 等待 Consumer 支付...")
    print(f"  💡 在另一个终端运行:")
    print(f"     cd agentfleet-skill")
    print(f"     python -m agentfleet_skill.cli pay --provider {agent_id} --amount 5")
